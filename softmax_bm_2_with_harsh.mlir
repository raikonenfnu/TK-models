  ...
  stream.executable private @test {
    ...
    builtin.module {
      func.func @test(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %0 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<256x1024xf32, strided<[1024, 1], offset: ?>>
        %1 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<256x1024xf32, strided<[1024, 1], offset: ?>>
        %2 = arith.muli %workgroup_id_1, %c2 : index
        %3 = arith.muli %thread_id_y, %c3 : index
        %4 = arith.addi %3, %2 : index
        %5 = arith.muli %thread_id_x, %c2 : index
        %6 = arith.divsi %thread_id_x, %c64 : index
        %7 = arith.muli %6, %c128 : index
        %8 = arith.muli %workgroup_id_0, %c1024 : index
        %9 = arith.addi %8, %7 : index
        %10 = arith.addi %4, %c1 : index
        %11:4 = scf.for %arg3 = %c0 to %c8 step %c1 iter_args(%arg4 = %cst, %arg5 = %cst_0, %arg6 = %cst, %arg7 = %cst_0) -> (vector<1xf32>, vector<1xf32>, vector<1xf32>, vector<1xf32>) {
          %19 = arith.muli %arg3, %c128 : index
          %20 = arith.addi %9, %19 : index
          %21 = arith.addi %20, %5 : index
          %22 = vector.load %0[%4, %21] : memref<256x1024xf32, strided<[1024, 1], offset: ?>>, vector<2xf32>
          %23 = vector.load %0[%10, %21] : memref<256x1024xf32, strided<[1024, 1], offset: ?>>, vector<2xf32>
          %24 = vector.load %1[%4, %21] : memref<256x1024xf32, strided<[1024, 1], offset: ?>>, vector<2xf32>
          %25 = vector.load %1[%10, %21] : memref<256x1024xf32, strided<[1024, 1], offset: ?>>, vector<2xf32>
          %26 = arith.mulf %22, %24 : vector<2xf32>
          ...
          %71 = arith.maximumf %arg5, %70 : vector<1xf32>
          ...
          %91 = arith.addf %arg6, %90 : vector<1xf32>
          ...
          scf.yield %49, %111, %71, %91 : vector<1xf32>, vector<1xf32>, vector<1xf32>, vector<1xf32>
        }
        %12 = arith.divf %11#0, %11#1 : vector<1xf32>
        %13 = arith.divf %11#2, %11#3 : vector<1xf32>
        %14 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<256xf32, strided<[1], offset: ?>>
        %15 = arith.muli %workgroup_id_1, %c2 : index
        %16 = arith.muli %thread_id_y, %c3 : index
        %17 = arith.addi %16, %15 : index
        vector.store %12, %14[%17] : memref<256xf32, strided<[1], offset: ?>>, vector<1xf32>
        %18 = arith.addi %17, %c1 : index
        vector.store %13, %14[%18] : memref<256xf32, strided<[1], offset: ?>>, vector<1xf32>
        return
      }
    }
  }
  func.func @isolated_benchmark(%arg0: tensor<256x1024xf32>, %arg1: tensor<256x1024xf32>) -> tensor<256xf32> {
    %0 = flow.dispatch @test::@test(%arg0, %arg1) : (tensor<256x1024xf32>, tensor<256x1024xf32>) -> tensor<256xf32>
